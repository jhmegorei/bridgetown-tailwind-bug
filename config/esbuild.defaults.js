...
//
// Shipped with Bridgetown v1.3.2
...
const bridgetownPreset = (bridgetownConfig) => ({
  ...
  async setup(build) {
    ...
    build.onEnd(async (result) => {
      ...
      console.log('>>> looping through outputs')
      ...
      for (const key in result.metafile.outputs) {
        ...
        console.log('  >>> processing output', key)

        if (value.entryPoint) {
          console.log('    >>> value has an entrypoint')
          ...
          console.log('    >>> value is an index-file')
          ...
          console.log('    >>> no special treatment, just using the first input')
